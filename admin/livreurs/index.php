...
?>
    ...
    <head>
        ...
        <title> Livreurs | Admin SOUAIBOU DISTRIBUTION </title>
    ...
    <body class="sb-nav-fixed">
        ...
        <script>
            document.addEventListener("DOMContentLoaded", function() {
                ...
                const produitsLink = document.querySelector('a[href="/admin/livreurs/"]');
                const produitsCollapse = document.getElementById("collapseLivreurs");


                if (currentUrl.startsWith("/admin/livreurs/")) {
